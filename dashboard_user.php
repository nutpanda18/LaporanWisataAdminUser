...
<head>
    <meta charset="UTF-8">
    <title>Sistem Laporan Wisata - Madiun</title>
...
<body class="bg-stone-50">
    ...
    <nav class="bg-[#4a2c1d] text-white shadow-lg sticky top-0 z-50">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-6 text-sm">
                ...
                <span class="text-amber-300 font-bold">Hi, <?= $currentUser; ?></span>
    ...
    <div class="container mx-auto px-4 py-10 max-w-6xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
                        ...
                        <table class="w-full text-left">
                            <thead class="bg-orange-50 text-orange-900">
                                <tr>
                                    ...
                                    <th class="p-4 text-xs font-black uppercase">Lokasi</th>
                            ...
                            <tbody class="text-xs divide-y divide-orange-50">
                                ...
                                <tr class="hover:bg-orange-50/30 transition">
                                    <td class="p-4 text-gray-400"><?= $r['tanggal_laporan']; ?></td>
                                    <td class="p-4 font-bold text-orange-900"><?= $r['lokasi_wisata']; ?></td>
                                    <td class="p-4 text-gray-500 italic"><?= $r['isi_laporan']; ?></td>
                                    <td class="p-4 text-center">
                                        <span class="px-3 py-1 bg-amber-100 text-orange-800 rounded-md text-[9px] font-black uppercase"><?= $r['status']; ?></span>
                                    </td>
                                </tr>
                                <?php endwhile; ?>
                            </tbody>
            ...
            <div class="glass-card bg-white p-8 rounded-3xl shadow-xl border-t-8 border-orange-600 h-fit">
                ...
                <form action="proses_simpan.php" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="isi_laporan" rows="4" class="w-full px-4 py-3 rounded-xl border border-stone-200 focus:ring-2 focus:ring-orange-500 outline-none" placeholder="Jelaskan masalah fasilitas atau kebersihan..." required></textarea>
                    </div>
