                    ...
                    <table class="w-full text-left text-xs">
                        ...
                        <tbody class="divide-y divide-orange-50">
                            ...
                            <tr class="hover:bg-orange-50/30 transition-colors">
                                <td class="p-4 text-gray-400"><?= $row['tanggal_laporan']; ?></td>
                                <td class="p-4 font-bold text-orange-800"><?= htmlspecialchars($row['nama_pelapor']); ?></td>
                                <td class="p-4"><?= htmlspecialchars($row['lokasi_wisata']); ?></td>
                                ...
                                <td class="p-4">
                                    <div class="flex justify-center gap-2">
                                        <?php if($row['status'] !== 'Selesai'): ?>
                                            <a href="update_status.php?id=<?= $row['id_laporan']; ?>" class="bg-green-500 hover:bg-green-600 text-white px-3 py-1.5 rounded-lg font-black text-[9px] uppercase transition-all">Selesaikan</a>
                                        <?php endif; ?>
                                        <a href="hapus_laporan.php?id=<?= $row['id_laporan']; ?>" onclick="return confirm('Hapus laporan ini?')" class="bg-red-500 hover:bg-red-600 text-white px-3 py-1.5 rounded-lg font-black text-[9px] uppercase transition-all">Hapus</a>
                                    </div>
                                </td>
                            </tr>
                            <?php endwhile; ?>
